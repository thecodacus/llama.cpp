...
static __global__ void flash_attn_ext_vec(
    ...
    // Turbo K uses the float Q path (like f16/bf16), not the q8_1 integer path.
    constexpr bool K_is_turbo = (type_K == GGML_TYPE_TURBO3_0 || type_K == GGML_TYPE_TURBO2_0 || type_K == GGML_TYPE_TURBO4_0);
    constexpr int nthreads_KQ = (type_K == GGML_TYPE_F16 || type_K == GGML_TYPE_BF16 || K_is_turbo) ? 128 / cpy_nb : nthreads_KQ_q;
    ...
    constexpr bool Q_q8_1 = type_K != GGML_TYPE_F16 && type_K != GGML_TYPE_BF16 && !K_is_turbo;
...
// TurboQuant KV cache type combinations (see template-instances/fattn-vec-instance-*turbo*.cu)
